...
class TypeSpeedGUI:
    ...
    def __init__(self):
        ...
        self.text = open(r"C:\Users\edmha\OneDrive\Desktop\program\texts.txt").read().split("\n")
        ...
        self.reset_button = tk.Button(self.frame, text="Reset", command=self.reset, font=("Helvetica", 20))
